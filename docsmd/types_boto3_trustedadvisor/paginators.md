...
) -> PageIterator[ListChecksResponseTypeDef]:  # (5)
    ...
```
...
) -> PageIterator[ListOrganizationRecommendationAccountsResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListOrganizationRecommendationResourcesResponseTypeDef]:  # (4)
    ...
```
...
) -> PageIterator[ListOrganizationRecommendationsResponseTypeDef]:  # (6)
    ...
```
...
def paginate(
    ...
    *,
    ...
    status: ResourceStatusType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> PageIterator[ListRecommendationResourcesResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    type: RecommendationTypeType = ...,  # (4)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (5)
) -> PageIterator[ListRecommendationsResponseTypeDef]:  # (6)
    ...
```
