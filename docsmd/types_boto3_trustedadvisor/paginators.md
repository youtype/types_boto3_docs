...
) -> _PageIterator[ListChecksResponseTypeDef]:  # (5)
    ...
```
...
) -> _PageIterator[ListOrganizationRecommendationAccountsResponseTypeDef]:  # (2)
    ...
```
...
) -> _PageIterator[ListOrganizationRecommendationResourcesResponseTypeDef]:  # (4)
    ...
```
...
) -> _PageIterator[ListOrganizationRecommendationsResponseTypeDef]:  # (6)
    ...
```
...
def paginate(
    ...
    *,
    ...
    status: ResourceStatusType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> _PageIterator[ListRecommendationResourcesResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    type: RecommendationTypeType = ...,  # (4)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (5)
) -> _PageIterator[ListRecommendationsResponseTypeDef]:  # (6)
    ...
```
