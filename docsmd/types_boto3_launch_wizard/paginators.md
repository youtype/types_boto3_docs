...
) -> _PageIterator[ListDeploymentEventsOutputTypeDef]:  # (2)
    ...
```
...
) -> _PageIterator[ListDeploymentsOutputTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    workloadName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListWorkloadDeploymentPatternsOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListWorkloadsOutputTypeDef]:  # (2)
    ...
```
