...
) -> botocore.paginate.PageIterator[ListContactsResponseTypeDef]:  # (3)
    ...
```

1. See `Sequence[ContactStatusType]`
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
3. See `PageIterator[ListContactsResponseTypeDef]`
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> botocore.paginate.PageIterator[ListEphemeridesResponseTypeDef]:  # (3)
    ...
```

1. See `Sequence[EphemerisStatusType]`
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
3. See `PageIterator[ListEphemeridesResponseTypeDef]`
