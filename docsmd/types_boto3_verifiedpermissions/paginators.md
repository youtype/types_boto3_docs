...
) -> _PageIterator[ListIdentitySourcesOutputTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[ListPoliciesOutputTypeDef]:  # (3)
    ...
```
...
) -> _PageIterator[ListPolicyStoresOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    policyStoreId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListPolicyTemplatesOutputTypeDef]:  # (2)
    ...
```
