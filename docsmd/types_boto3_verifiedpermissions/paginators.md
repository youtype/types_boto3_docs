...
) -> PageIterator[ListIdentitySourcesOutputTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListPoliciesOutputTypeDef]:  # (3)
    ...
```
...
) -> PageIterator[ListPolicyStoresOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    policyStoreId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListPolicyTemplatesOutputTypeDef]:  # (2)
    ...
```
