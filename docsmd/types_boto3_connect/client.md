...
def create_evaluation_form(
    ...
    *,
    ...
    AsDraft: bool = ...,
    Tags: Mapping[str, str] = ...,
    TargetConfiguration: EvaluationFormTargetConfigurationTypeDef = ...,  # (4)
    LanguageConfiguration: EvaluationFormLanguageConfigurationTypeDef = ...,  # (5)
) -> CreateEvaluationFormResponseTypeDef:  # (6)
    ...
```
...
6. See [:material-code-braces: CreateEvaluationFormResponseTypeDef](./type_defs.md#createevaluationformresponsetypedef)
...
def start_chat_contact(
    ...
    *,
    ...
    CustomerId: str = ...,
) -> StartChatContactResponseTypeDef:  # (6)
    ...
```
...
6. See [:material-code-braces: StartChatContactResponseTypeDef](./type_defs.md#startchatcontactresponsetypedef)
...
def update_evaluation_form(
    ...
    *,
    ...
    TargetConfiguration: EvaluationFormTargetConfigurationTypeDef = ...,  # (4)
    LanguageConfiguration: EvaluationFormLanguageConfigurationTypeDef = ...,  # (5)
) -> UpdateEvaluationFormResponseTypeDef:  # (6)
    ...
```
...
4. See [:material-code-braces: EvaluationFormTargetConfigurationTypeDef](./type_defs.md#evaluationformtargetconfigurationtypedef)
5. See [:material-code-braces: EvaluationFormLanguageConfigurationTypeDef](./type_defs.md#evaluationformlanguageconfigurationtypedef)
6. See [:material-code-braces: UpdateEvaluationFormResponseTypeDef](./type_defs.md#updateevaluationformresponsetypedef)
