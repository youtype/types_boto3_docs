...
3. item: `PageIterator[SearchContactsResponseTypeDef]`
...
def paginate(
    ...
    *,
    ...
    Sort: SortTypeDef = ...,  # (3)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (4)
) -> botocore.paginate.PageIterator[SearchContactsResponseTypeDef]:  # (5)
    ...
```
...
4. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
5. See `PageIterator[SearchContactsResponseTypeDef]`
