...
class EvaluationMetadataTypeDef(TypedDict):
    ...
    ContactParticipant: NotRequired[EvaluationContactParticipantTypeDef],  # (4)
    SamplingJobId: NotRequired[str],
```
...
4. See [:material-code-braces: EvaluationContactParticipantTypeDef](./type_defs.md#evaluationcontactparticipanttypedef)
