...
Can be used with `types-boto3[account-access]` package installed.
...
With `types-boto3-lite[account-access]`
or a standalone `types_boto3_account_access` package, you have to explicitly specify `client: AccountAccessClient` type annotation.
...
from types_boto3_account_access.client import AccountAccessClient
from types_boto3_account_access.paginator import ListApplicationsPaginator
...
from types_boto3_account_access.client import AccountAccessClient
from types_boto3_account_access.waiter import ApplicationActiveWaiter
