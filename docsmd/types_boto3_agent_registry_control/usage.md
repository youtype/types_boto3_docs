...
Can be used with `types-boto3[agent-registry-control]` package installed.
...
With `types-boto3-lite[agent-registry-control]`
or a standalone `types_boto3_agent_registry_control` package, you have to explicitly specify `client: AgentRegistryControlClient` type annotation.
