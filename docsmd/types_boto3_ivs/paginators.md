...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListPlaybackKeyPairsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListRecordingConfigurationsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    channelArn: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListStreamKeysResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListStreamsResponseTypeDef]:  # (3)
    ...
```
