...
) -> PageIterator[ListContactChannelsResultTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListContactsResultTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListEngagementsResultTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    PageId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListPageReceiptsResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    PageId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListPageResolutionsResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ContactId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListPagesByContactResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    EngagementId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListPagesByEngagementResultTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListPreviewRotationShiftsResultTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    EndTime: TimestampTypeDef,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListRotationOverridesResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    StartTime: TimestampTypeDef = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListRotationShiftsResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListRotationsResultTypeDef]:  # (2)
    ...
```
