...
) -> _PageIterator[ListDICOMImportJobsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[ListDatastoresResponseTypeDef]:  # (3)
    ...
```
...
) -> _PageIterator[ListImageSetVersionsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[SearchImageSetsResponseTypeDef]:  # (3)
    ...
```
