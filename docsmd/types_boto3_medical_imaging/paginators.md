...
) -> PageIterator[ListDICOMImportJobsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListDatastoresResponseTypeDef]:  # (3)
    ...
```
...
) -> PageIterator[ListImageSetVersionsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[SearchImageSetsResponseTypeDef]:  # (3)
    ...
```
