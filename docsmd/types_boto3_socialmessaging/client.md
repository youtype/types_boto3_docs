...
Type annotations and code completion for `#!python boto3.client("socialmessaging").close` method.
...
Type annotations and code completion for `#!python boto3.client("socialmessaging").delete_whatsapp_media_message` method.
