...
6. See [:material-code-braces: PutFunctionResponseTypeDef](./type_defs.md#putfunctionresponsetypedef)
...
def put_playback_configuration(
    ...
    *,
    ...
    AdsPersonalizationTimeouts: AdsPersonalizationTimeoutsTypeDef = ...,  # (11)
    AdsPersonalizationConcurrency: AdsPersonalizationConcurrencyTypeDef = ...,  # (12)
) -> PutPlaybackConfigurationResponseTypeDef:  # (13)
    ...
```
...
13. See [:material-code-braces: PutPlaybackConfigurationResponseTypeDef](./type_defs.md#putplaybackconfigurationresponsetypedef)
