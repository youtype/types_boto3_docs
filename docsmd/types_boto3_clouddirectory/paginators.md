...
) -> PageIterator[ListAppliedSchemaArnsResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListAttachedIndicesResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListDevelopmentSchemaArnsResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListDirectoriesResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Name: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListFacetAttributesResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    SchemaArn: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListFacetNamesResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListIncomingTypedLinksResponseTypeDef]:  # (6)
    ...
```
...
) -> PageIterator[ListIndexResponseTypeDef]:  # (5)
    ...
```
...
def paginate(
    ...
    *,
    SchemaArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListManagedSchemaArnsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (4)
) -> PageIterator[ListObjectAttributesResponseTypeDef]:  # (5)
    ...
```
...
def paginate(
    ...
    *,
    ...
    ObjectReference: ObjectReferenceTypeDef,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListObjectParentPathsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    ConsistencyLevel: ConsistencyLevelType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> PageIterator[ListObjectPoliciesResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    ConsistencyLevel: ConsistencyLevelType = ...,  # (4)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (5)
) -> PageIterator[ListOutgoingTypedLinksResponseTypeDef]:  # (6)
    ...
```
...
def paginate(
    ...
    *,
    ...
    ConsistencyLevel: ConsistencyLevelType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> PageIterator[ListPolicyAttachmentsResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    SchemaArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListPublishedSchemaArnsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Name: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListTypedLinkFacetAttributesResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    SchemaArn: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListTypedLinkFacetNamesResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    ObjectReference: ObjectReferenceTypeDef,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[LookupPolicyResponseTypeDef]:  # (3)
    ...
```
