...
class AdditionalInfoResponseTypeDef(TypedDict):
    ...
    vietnamAdditionalInfo: NotRequired[VietnamAdditionalInfoTypeDef],  # (20)
```
...
20. See [:material-code-braces: VietnamAdditionalInfoTypeDef](./type_defs.md#vietnamadditionalinfotypedef)
...
class AdditionalInfoRequestTypeDef(TypedDict):
    ...
    uzbekistanAdditionalInfo: NotRequired[UzbekistanAdditionalInfoTypeDef],  # (17)
...
17. See [:material-code-braces: UzbekistanAdditionalInfoTypeDef](./type_defs.md#uzbekistanadditionalinfotypedef)
