...
) -> _PageIterator[DescribeBackupsResponsePaginatorTypeDef]:  # (3)
    ...
```
...
) -> _PageIterator[DescribeFileSystemsResponsePaginatorTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[DescribeVolumesResponsePaginatorTypeDef]:  # (3)
    ...
```
