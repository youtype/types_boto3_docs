...
def paginate(
    ...
    *,
    Name: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListJobRunsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    Name: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListRecipeVersionsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    RecipeVersion: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListRecipesResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    JobName: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListSchedulesResponseTypeDef]:  # (2)
    ...
```
