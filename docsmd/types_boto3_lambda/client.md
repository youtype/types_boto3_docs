...
) -> CreateCapacityProviderResponseTypeDef:  # (6)
    ...
```
...
6. See [:material-code-braces: CreateCapacityProviderResponseTypeDef](./type_defs.md#createcapacityproviderresponsetypedef)
