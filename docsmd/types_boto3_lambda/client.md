...
def create_function(
    ...
    *,
    ...
    TenancyConfig: TenancyConfigTypeDef = ...,  # (14)
) -> FunctionConfigurationResponseTypeDef:  # (15)
    ...
```
...
14. See [:material-code-braces: TenancyConfigTypeDef](./type_defs.md#tenancyconfigtypedef)
15. See [:material-code-braces: FunctionConfigurationResponseTypeDef](./type_defs.md#functionconfigurationresponsetypedef)
