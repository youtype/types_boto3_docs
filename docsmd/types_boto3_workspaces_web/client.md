...
) -> CreateUserSettingsResponseTypeDef:  # (11)
    ...
```
...
11. See [:material-code-braces: CreateUserSettingsResponseTypeDef](./type_defs.md#createusersettingsresponsetypedef)
...
) -> UpdateUserSettingsResponseTypeDef:  # (10)
    ...
```
...
10. See [:material-code-braces: UpdateUserSettingsResponseTypeDef](./type_defs.md#updateusersettingsresponsetypedef)
