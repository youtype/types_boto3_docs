...
) -> PageIterator[ListClientDevicesAssociatedWithCoreDeviceResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    arn: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListComponentVersionsResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListComponentsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    runtime: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListCoreDevicesResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    parentTargetArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListDeploymentsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    coreDeviceThingName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListEffectiveDeploymentsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListInstalledComponentsResponseTypeDef]:  # (3)
    ...
```
