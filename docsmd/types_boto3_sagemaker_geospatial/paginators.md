...
) -> PageIterator[ListEarthObservationJobOutputTypeDef]:  # (4)
    ...
```
...
) -> PageIterator[ListRasterDataCollectionsOutputTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListVectorEnrichmentJobOutputTypeDef]:  # (3)
    ...
```
