...
def paginate(
    ...
    *,
    name: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListDecoderManifestSignalsResponsePaginatorTypeDef]:  # (2)
    ...
```
...
) -> _PageIterator[ListSignalCatalogNodesResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListStateTemplatesResponseTypeDef]:  # (2)
    ...
```
