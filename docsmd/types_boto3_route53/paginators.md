...
) -> PageIterator[ListCidrBlocksResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListCidrCollectionsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    CollectionId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListCidrLocationsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListHealthChecksResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListHostedZonesResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    HostedZoneId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListQueryLoggingConfigsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    HostedZoneId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListResourceRecordSetsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    MaxResults: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListVPCAssociationAuthorizationsResponseTypeDef]:  # (2)
    ...
```
