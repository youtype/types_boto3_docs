...
def paginate(
    ...
    *,
    ...
    reverseOrder: bool = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ActivityTypeInfosTypeDef]:  # (3)
    ...
```
...
) -> PageIterator[WorkflowExecutionInfosTypeDef]:  # (8)
    ...
```
...
def paginate(
    ...
    *,
    ...
    reverseOrder: bool = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[DomainInfosTypeDef]:  # (3)
    ...
```
...
) -> PageIterator[WorkflowExecutionInfosTypeDef]:  # (6)
    ...
```
...
def paginate(
    ...
    *,
    ...
    reverseOrder: bool = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[WorkflowTypeInfosTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[DecisionTaskTypeDef]:  # (3)
    ...
```
