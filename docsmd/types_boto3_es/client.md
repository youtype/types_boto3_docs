...
) -> CreateElasticsearchDomainResponseTypeDef:  # (15)
    ...
```
...
15. See [:material-code-braces: CreateElasticsearchDomainResponseTypeDef](./type_defs.md#createelasticsearchdomainresponsetypedef)
...
) -> UpdateElasticsearchDomainConfigResponseTypeDef:  # (14)
    ...
```
...
14. See [:material-code-braces: UpdateElasticsearchDomainConfigResponseTypeDef](./type_defs.md#updateelasticsearchdomainconfigresponsetypedef)
