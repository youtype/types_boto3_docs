...
or a standalone `types_boto3_bedrock_agentcore_control` package, you have to explicitly specify `client: BedrockAgentCoreControlPlaneFrontingLayerClient` type annotation.
