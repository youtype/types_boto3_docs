...
class CreateGatewayResponseTypeDef(TypedDict):
    ...
    workloadIdentityDetails: WorkloadIdentityDetailsTypeDef,  # (7)
...
7. See [:material-code-braces: WorkloadIdentityDetailsTypeDef](./type_defs.md#workloadidentitydetailstypedef)
...
class ModifyStrategyConfigurationTypeDef(TypedDict):
    ...
    selfManagedConfiguration: NotRequired[ModifySelfManagedConfigurationTypeDef],  # (3)
```
...
3. See [:material-code-braces: ModifySelfManagedConfigurationTypeDef](./type_defs.md#modifyselfmanagedconfigurationtypedef)
...
class CustomConfigurationInputTypeDef(TypedDict):
    ...
    selfManagedConfiguration: NotRequired[SelfManagedConfigurationInputTypeDef],  # (4)
```
...
4. See [:material-code-braces: SelfManagedConfigurationInputTypeDef](./type_defs.md#selfmanagedconfigurationinputtypedef)
...
class StrategyConfigurationTypeDef(TypedDict):
    ...
    selfManagedConfiguration: NotRequired[SelfManagedConfigurationTypeDef],  # (4)
```
...
4. See [:material-code-braces: SelfManagedConfigurationTypeDef](./type_defs.md#selfmanagedconfigurationtypedef)
...
class CreateGatewayRequestTypeDef(TypedDict):
    ...
    exceptionLevel: NotRequired[ExceptionLevelType],  # (6)
    tags: NotRequired[Mapping[str, str]],
```
...
6. See [:material-code-brackets: ExceptionLevelType](./literals.md#exceptionleveltype)
