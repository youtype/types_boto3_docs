...
class CustomOauth2ProviderConfigInputTypeDef(TypedDict):
    ...
    clientAuthenticationMethod: NotRequired[ClientAuthenticationMethodTypeType],  # (5)
    privateEndpoint: NotRequired[PrivateEndpointUnionTypeDef],  # (6)
    privateEndpointOverrides: NotRequired[Sequence[PrivateEndpointOverrideUnionTypeDef]],  # (7)
```
...
5. See [:material-code-brackets: ClientAuthenticationMethodTypeType](./literals.md#clientauthenticationmethodtypetype)
6. See [:material-code-braces: PrivateEndpointUnionTypeDef](#privateendpointuniontypedef)
7. See `Sequence[PrivateEndpointOverrideUnionTypeDef]`
