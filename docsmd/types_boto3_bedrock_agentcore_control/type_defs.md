...
class GetAgentRuntimeResponseTypeDef(TypedDict):
    ...
    lastUpdatedAt: datetime.datetime,
    roleArn: str,
    agentRuntimeArtifact: AgentRuntimeArtifactTypeDef,  # (2)
    networkConfiguration: NetworkConfigurationOutputTypeDef,  # (3)
    protocolConfiguration: ProtocolConfigurationTypeDef,  # (4)
    environmentVariables: Dict[str, str],
    authorizerConfiguration: AuthorizerConfigurationOutputTypeDef,  # (5)
    requestHeaderConfiguration: RequestHeaderConfigurationOutputTypeDef,  # (6)
    status: AgentRuntimeStatusType,  # (7)
    ResponseMetadata: ResponseMetadataTypeDef,  # (8)
```

1. See [:material-code-braces: WorkloadIdentityDetailsTypeDef](./type_defs.md#workloadidentitydetailstypedef)
2. See [:material-code-braces: AgentRuntimeArtifactTypeDef](./type_defs.md#agentruntimeartifacttypedef)
...
6. See [:material-code-braces: RequestHeaderConfigurationOutputTypeDef](./type_defs.md#requestheaderconfigurationoutputtypedef)
7. See [:material-code-brackets: AgentRuntimeStatusType](./literals.md#agentruntimestatustype)
...
class CreateAgentRuntimeRequestTypeDef(TypedDict):
    ...
    requestHeaderConfiguration: NotRequired[RequestHeaderConfigurationUnionTypeDef],  # (5)
    tags: NotRequired[Mapping[str, str]],
```
...
5. See [:material-code-braces: RequestHeaderConfigurationUnionTypeDef](#requestheaderconfigurationuniontypedef)
