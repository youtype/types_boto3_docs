...
def create_online_evaluation_config(
    ...
    *,
    ...
    tags: Mapping[str, str] = ...,
) -> CreateOnlineEvaluationConfigResponseTypeDef:  # (6)
    ...
```
...
6. See [:material-code-braces: CreateOnlineEvaluationConfigResponseTypeDef](./type_defs.md#createonlineevaluationconfigresponsetypedef)
...
) -> UpdateOnlineEvaluationConfigResponseTypeDef:  # (7)
    ...
```
...
7. See [:material-code-braces: UpdateOnlineEvaluationConfigResponseTypeDef](./type_defs.md#updateonlineevaluationconfigresponsetypedef)
