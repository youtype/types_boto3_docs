...
def create_agent_runtime(
    ...
    *,
    ...
    requestHeaderConfiguration: RequestHeaderConfigurationUnionTypeDef = ...,  # (5)
    tags: Mapping[str, str] = ...,
) -> CreateAgentRuntimeResponseTypeDef:  # (6)
    ...
```
...
6. See [:material-code-braces: CreateAgentRuntimeResponseTypeDef](./type_defs.md#createagentruntimeresponsetypedef)
...
def update_agent_runtime(
    ...
    *,
    ...
    authorizerConfiguration: AuthorizerConfigurationUnionTypeDef = ...,  # (4)
    requestHeaderConfiguration: RequestHeaderConfigurationUnionTypeDef = ...,  # (5)
) -> UpdateAgentRuntimeResponseTypeDef:  # (6)
    ...
```
...
4. See [:material-code-braces: AuthorizerConfigurationUnionTypeDef](#authorizerconfigurationuniontypedef)
5. See [:material-code-braces: RequestHeaderConfigurationUnionTypeDef](#requestheaderconfigurationuniontypedef)
6. See [:material-code-braces: UpdateAgentRuntimeResponseTypeDef](./type_defs.md#updateagentruntimeresponsetypedef)
