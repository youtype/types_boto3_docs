...
def create_gateway(
    ...
    *,
    ...
    exceptionLevel: ExceptionLevelType = ...,  # (6)
    tags: Mapping[str, str] = ...,
) -> CreateGatewayResponseTypeDef:  # (7)
    ...
```
...
7. See [:material-code-braces: CreateGatewayResponseTypeDef](./type_defs.md#creategatewayresponsetypedef)
...
def update_gateway(
    ...
    *,
    ...
    interceptorConfigurations: Sequence[GatewayInterceptorConfigurationUnionTypeDef] = ...,  # (5)
    exceptionLevel: ExceptionLevelType = ...,  # (6)
) -> UpdateGatewayResponseTypeDef:  # (7)
    ...
```
...
5. See `Sequence[GatewayInterceptorConfigurationUnionTypeDef]`
6. See [:material-code-brackets: ExceptionLevelType](./literals.md#exceptionleveltype)
7. See [:material-code-braces: UpdateGatewayResponseTypeDef](./type_defs.md#updategatewayresponsetypedef)
