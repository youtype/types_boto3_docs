...
) -> PageIterator[ListBucketsOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListDirectoryBucketsOutputTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListMultipartUploadsOutputTypeDef]:  # (4)
    ...
```
...
) -> PageIterator[ListObjectVersionsOutputTypeDef]:  # (5)
    ...
```
...
def paginate(
    ...
    *,
    ...
    OptionalObjectAttributes: Sequence[OptionalObjectAttributesType] = ...,  # (3)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (4)
) -> PageIterator[ListObjectsOutputTypeDef]:  # (5)
    ...
```
...
def paginate(
    ...
    *,
    ...
    OptionalObjectAttributes: Sequence[OptionalObjectAttributesType] = ...,  # (3)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (4)
) -> PageIterator[ListObjectsV2OutputTypeDef]:  # (5)
    ...
```
...
) -> PageIterator[ListPartsOutputTypeDef]:  # (3)
    ...
```
