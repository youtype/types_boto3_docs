...
def paginate(
    ...
    *,
    templateId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListTemplateStepGroupsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    stepGroupId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListTemplateStepsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    name: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListMigrationWorkflowTemplatesResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    workflowId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListWorkflowStepGroupsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    stepGroupId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListWorkflowStepsResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListMigrationWorkflowsResponseTypeDef]:  # (3)
    ...
```
