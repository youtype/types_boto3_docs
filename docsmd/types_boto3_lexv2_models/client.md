...
def create_bot_locale(
    ...
    *,
    ...
    speechDetectionSensitivity: SpeechDetectionSensitivityType = ...,  # (3)
) -> CreateBotLocaleResponseTypeDef:  # (4)
    ...
```
...
4. See [:material-code-braces: CreateBotLocaleResponseTypeDef](./type_defs.md#createbotlocaleresponsetypedef)
...
def update_bot_locale(
    ...
    *,
    ...
    generativeAISettings: GenerativeAISettingsTypeDef = ...,  # (2)
    speechDetectionSensitivity: SpeechDetectionSensitivityType = ...,  # (3)
) -> UpdateBotLocaleResponseTypeDef:  # (4)
    ...
```
...
2. See [:material-code-braces: GenerativeAISettingsTypeDef](./type_defs.md#generativeaisettingstypedef)
3. See [:material-code-brackets: SpeechDetectionSensitivityType](./literals.md#speechdetectionsensitivitytype)
4. See [:material-code-braces: UpdateBotLocaleResponseTypeDef](./type_defs.md#updatebotlocaleresponsetypedef)
