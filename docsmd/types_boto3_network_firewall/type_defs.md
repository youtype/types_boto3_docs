...
```python
# VpcEndpointUnionTypeDef Union usage example

from types_boto3_network_firewall.type_defs import VpcEndpointUnionTypeDef


def get_value() -> VpcEndpointUnionTypeDef:
    return ...


# VpcEndpointUnionTypeDef definition

VpcEndpointUnionTypeDef = Union[
    VpcEndpointTypeDef,  # (1)
    VpcEndpointOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: VpcEndpointTypeDef](./type_defs.md#vpcendpointtypedef)
2. See [:material-code-braces: VpcEndpointOutputTypeDef](./type_defs.md#vpcendpointoutputtypedef)

## ContainerMonitoringConfigurationUnionTypeDef

```python
# ContainerMonitoringConfigurationUnionTypeDef Union usage example

from types_boto3_network_firewall.type_defs import ContainerMonitoringConfigurationUnionTypeDef


def get_value() -> ContainerMonitoringConfigurationUnionTypeDef:
    return ...


# ContainerMonitoringConfigurationUnionTypeDef definition

ContainerMonitoringConfigurationUnionTypeDef = Union[
    ContainerMonitoringConfigurationTypeDef,  # (1)
    ContainerMonitoringConfigurationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: ContainerMonitoringConfigurationTypeDef](./type_defs.md#containermonitoringconfigurationtypedef)
2. See [:material-code-braces: ContainerMonitoringConfigurationOutputTypeDef](./type_defs.md#containermonitoringconfigurationoutputtypedef)

## ProxySettingsUnionTypeDef

```python
# ProxySettingsUnionTypeDef Union usage example

from types_boto3_network_firewall.type_defs import ProxySettingsUnionTypeDef


def get_value() -> ProxySettingsUnionTypeDef:
    return ...


# ProxySettingsUnionTypeDef definition

ProxySettingsUnionTypeDef = Union[
    ProxySettingsTypeDef,  # (1)
    ProxySettingsOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: ProxySettingsTypeDef](./type_defs.md#proxysettingstypedef)
2. See [:material-code-braces: ProxySettingsOutputTypeDef](./type_defs.md#proxysettingsoutputtypedef)
...
```python
# ContainerAssociationSummaryTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import ContainerAssociationSummaryTypeDef


def get_value() -> ContainerAssociationSummaryTypeDef:
    return {
        "Arn": ...,
    }


# ContainerAssociationSummaryTypeDef definition
...
from types_boto3_network_firewall.type_defs import ContainerAttributeTypeDef
...
```python
# NatGatewayMappingTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import NatGatewayMappingTypeDef


def get_value() -> NatGatewayMappingTypeDef:
    return {
        "NatGatewayId": ...,
    }


# NatGatewayMappingTypeDef definition
...
```python
# DeleteContainerAssociationRequestTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import DeleteContainerAssociationRequestTypeDef


def get_value() -> DeleteContainerAssociationRequestTypeDef:
    return {
        "ContainerAssociationName": ...,
    }


# DeleteContainerAssociationRequestTypeDef definition
...
```python
# DescribeContainerAssociationRequestTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import DescribeContainerAssociationRequestTypeDef


def get_value() -> DescribeContainerAssociationRequestTypeDef:
    return {
        "ContainerAssociationName": ...,
    }


# DescribeContainerAssociationRequestTypeDef definition
...
```python
# ListContainerAssociationsRequestTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import ListContainerAssociationsRequestTypeDef


def get_value() -> ListContainerAssociationsRequestTypeDef:
    return {
        "MaxResults": ...,
    }


# ListContainerAssociationsRequestTypeDef definition
...
```python
# NatGatewayAttachmentTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import NatGatewayAttachmentTypeDef


def get_value() -> NatGatewayAttachmentTypeDef:
    return {
        "NatGatewayId": ...,
    }


# NatGatewayAttachmentTypeDef definition

class NatGatewayAttachmentTypeDef(TypedDict):
    NatGatewayId: str,
    Status: NatGatewayAttachmentStatusType,  # (1)
    StatusMessage: NotRequired[str],
    DnsName: NotRequired[str],
```

1. See [:material-code-brackets: NatGatewayAttachmentStatusType](./literals.md#natgatewayattachmentstatustype)
...
```python
# DeleteContainerAssociationResponseTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import DeleteContainerAssociationResponseTypeDef


def get_value() -> DeleteContainerAssociationResponseTypeDef:
    return {
        "ContainerAssociationName": ...,
    }


# DeleteContainerAssociationResponseTypeDef definition

class DeleteContainerAssociationResponseTypeDef(TypedDict):
    ContainerAssociationName: str,
    ContainerAssociationArn: str,
    Status: ContainerAssociationStatusType,  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-brackets: ContainerAssociationStatusType](./literals.md#containerassociationstatustype)
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
```python
# VpcEndpointOutputTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import VpcEndpointOutputTypeDef


def get_value() -> VpcEndpointOutputTypeDef:
    return {
        "VpcId": ...,
    }


# VpcEndpointOutputTypeDef definition
...
from types_boto3_network_firewall.type_defs import VpcEndpointTypeDef
...
```python
# ListContainerAssociationsResponseTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import ListContainerAssociationsResponseTypeDef


def get_value() -> ListContainerAssociationsResponseTypeDef:
    return {
        "ContainerAssociations": ...,
    }


# ListContainerAssociationsResponseTypeDef definition

class ListContainerAssociationsResponseTypeDef(TypedDict):
    ContainerAssociations: list[ContainerAssociationSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    NextToken: NotRequired[str],
```

1. See `list[ContainerAssociationSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## ContainerMonitoringConfigurationOutputTypeDef

```python
# ContainerMonitoringConfigurationOutputTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import ContainerMonitoringConfigurationOutputTypeDef


def get_value() -> ContainerMonitoringConfigurationOutputTypeDef:
    return {
        "ClusterArn": ...,
    }


# ContainerMonitoringConfigurationOutputTypeDef definition

class ContainerMonitoringConfigurationOutputTypeDef(TypedDict):
    ClusterArn: str,
    AttributeFilters: NotRequired[list[ContainerAttributeTypeDef]],  # (1)
```

1. See `list[ContainerAttributeTypeDef]`

## ContainerMonitoringConfigurationTypeDef

```python
# ContainerMonitoringConfigurationTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import ContainerMonitoringConfigurationTypeDef


def get_value() -> ContainerMonitoringConfigurationTypeDef:
    return {
        "ClusterArn": ...,
    }


# ContainerMonitoringConfigurationTypeDef definition

class ContainerMonitoringConfigurationTypeDef(TypedDict):
    ClusterArn: str,
    AttributeFilters: NotRequired[Sequence[ContainerAttributeTypeDef]],  # (1)
```

1. See `Sequence[ContainerAttributeTypeDef]`
...
```python
# ProxySettingsOutputTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import ProxySettingsOutputTypeDef


def get_value() -> ProxySettingsOutputTypeDef:
    return {
        "ListenerProperties": ...,
    }


# ProxySettingsOutputTypeDef definition

class ProxySettingsOutputTypeDef(TypedDict):
    ListenerProperties: list[ListenerPropertyTypeDef],  # (1)
```

1. See `list[ListenerPropertyTypeDef]`

## ProxySettingsTypeDef

```python
# ProxySettingsTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import ProxySettingsTypeDef


def get_value() -> ProxySettingsTypeDef:
    return {
        "ListenerProperties": ...,
    }


# ProxySettingsTypeDef definition

class ProxySettingsTypeDef(TypedDict):
    ListenerProperties: Sequence[ListenerPropertyTypeDef],  # (1)
```

1. See `Sequence[ListenerPropertyTypeDef]`
...
```python
# ListContainerAssociationsRequestPaginateTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import ListContainerAssociationsRequestPaginateTypeDef


def get_value() -> ListContainerAssociationsRequestPaginateTypeDef:
    return {
        "PaginationConfig": ...,
    }


# ListContainerAssociationsRequestPaginateTypeDef definition
...
class SyncStateTypeDef(TypedDict):
    ...
    NatGatewayAttachments: NotRequired[list[NatGatewayAttachmentTypeDef]],  # (3)
```

1. See [:material-code-braces: AttachmentTypeDef](./type_defs.md#attachmenttypedef)
2. See `dict[str, PerObjectStatusTypeDef]`
3. See `list[NatGatewayAttachmentTypeDef]`
...
```python
# CreateContainerAssociationResponseTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import CreateContainerAssociationResponseTypeDef


def get_value() -> CreateContainerAssociationResponseTypeDef:
    return {
        "ContainerAssociationName": ...,
    }


# CreateContainerAssociationResponseTypeDef definition

class CreateContainerAssociationResponseTypeDef(TypedDict):
    ContainerAssociationName: str,
    ContainerAssociationArn: str,
    Description: str,
    Type: ContainerMonitoringTypeType,  # (1)
    ContainerMonitoringConfigurations: list[ContainerMonitoringConfigurationOutputTypeDef],  # (2)
    Status: ContainerAssociationStatusType,  # (3)
...
2. See `list[ContainerMonitoringConfigurationOutputTypeDef]`
3. See [:material-code-brackets: ContainerAssociationStatusType](./literals.md#containerassociationstatustype)
...
```python
# DescribeContainerAssociationResponseTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import DescribeContainerAssociationResponseTypeDef


def get_value() -> DescribeContainerAssociationResponseTypeDef:
    return {
        "ContainerAssociationName": ...,
    }


# DescribeContainerAssociationResponseTypeDef definition

class DescribeContainerAssociationResponseTypeDef(TypedDict):
    ContainerAssociationName: str,
    ContainerAssociationArn: str,
    Description: str,
    Type: ContainerMonitoringTypeType,  # (1)
...
```python
# UpdateContainerAssociationResponseTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import UpdateContainerAssociationResponseTypeDef


def get_value() -> UpdateContainerAssociationResponseTypeDef:
    return {
        "ContainerAssociationName": ...,
    }


# UpdateContainerAssociationResponseTypeDef definition

class UpdateContainerAssociationResponseTypeDef(TypedDict):
    ContainerAssociationName: str,
    ContainerAssociationArn: str,
    Description: str,
    Type: ContainerMonitoringTypeType,  # (1)
...
class FirewallTypeDef(TypedDict):
    ...
    NatGatewayMappings: NotRequired[list[NatGatewayMappingTypeDef]],  # (6)
    ProxySettings: NotRequired[ProxySettingsOutputTypeDef],  # (7)
    NoSourcePreservation: NotRequired[bool],
    VpcEndpoint: NotRequired[VpcEndpointOutputTypeDef],  # (8)
```
...
6. See `list[NatGatewayMappingTypeDef]`
7. See [:material-code-braces: ProxySettingsOutputTypeDef](./type_defs.md#proxysettingsoutputtypedef)
8. See [:material-code-braces: VpcEndpointOutputTypeDef](./type_defs.md#vpcendpointoutputtypedef)

## UpdateProxySettingsResponseTypeDef

```python
# UpdateProxySettingsResponseTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import UpdateProxySettingsResponseTypeDef


def get_value() -> UpdateProxySettingsResponseTypeDef:
    return {
        "FirewallArn": ...,
    }


# UpdateProxySettingsResponseTypeDef definition

class UpdateProxySettingsResponseTypeDef(TypedDict):
    FirewallArn: str,
    FirewallName: str,
    UpdateToken: str,
    ProxySettings: ProxySettingsOutputTypeDef,  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: ProxySettingsOutputTypeDef](./type_defs.md#proxysettingsoutputtypedef)
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
```python
# CreateContainerAssociationRequestTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import CreateContainerAssociationRequestTypeDef


def get_value() -> CreateContainerAssociationRequestTypeDef:
    return {
        "ContainerAssociationName": ...,
    }


# CreateContainerAssociationRequestTypeDef definition

class CreateContainerAssociationRequestTypeDef(TypedDict):
    ContainerAssociationName: str,
    Type: ContainerMonitoringTypeType,  # (1)
...
```python
# UpdateContainerAssociationRequestTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import UpdateContainerAssociationRequestTypeDef


def get_value() -> UpdateContainerAssociationRequestTypeDef:
    return {
        "Type": ...,
    }


# UpdateContainerAssociationRequestTypeDef definition

class UpdateContainerAssociationRequestTypeDef(TypedDict):
    Type: ContainerMonitoringTypeType,  # (1)
    ContainerMonitoringConfigurations: Sequence[ContainerMonitoringConfigurationUnionTypeDef],  # (2)
    UpdateToken: str,
    ContainerAssociationName: NotRequired[str],
...
class CreateFirewallRequestTypeDef(TypedDict):
    ...
    AvailabilityZoneChangeProtection: NotRequired[bool],
    NatGatewayMappings: NotRequired[Sequence[NatGatewayMappingTypeDef]],  # (6)
    ProxySettings: NotRequired[ProxySettingsUnionTypeDef],  # (7)
    NoSourcePreservation: NotRequired[bool],
    VpcEndpoint: NotRequired[VpcEndpointUnionTypeDef],  # (8)
```
...
```python
# UpdateProxySettingsRequestTypeDef TypedDict usage example

from types_boto3_network_firewall.type_defs import UpdateProxySettingsRequestTypeDef


def get_value() -> UpdateProxySettingsRequestTypeDef:
    return {
        "FirewallArn": ...,
    }


# UpdateProxySettingsRequestTypeDef definition

class UpdateProxySettingsRequestTypeDef(TypedDict):
    FirewallArn: NotRequired[str],
    FirewallName: NotRequired[str],
    UpdateToken: NotRequired[str],
    ProxySettings: NotRequired[ProxySettingsUnionTypeDef],  # (1)
```
