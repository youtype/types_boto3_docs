...
) -> _PageIterator[ListAppAssessmentResourceDriftsResponseTypeDef]:  # (2)
    ...
```
...
) -> _PageIterator[ListMetricsResponseTypeDef]:  # (5)
    ...
```
...
def paginate(
    ...
    *,
    appArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListResourceGroupingRecommendationsResponseTypeDef]:  # (2)
    ...
```
