...
) -> PageIterator[ListAppAssessmentResourceDriftsResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListMetricsResponseTypeDef]:  # (5)
    ...
```
...
def paginate(
    ...
    *,
    appArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListResourceGroupingRecommendationsResponseTypeDef]:  # (2)
    ...
```
