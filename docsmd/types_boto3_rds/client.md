...
) -> CreateDBInstanceResultTypeDef:  # (6)
    ...
```
...
6. See [:material-code-braces: CreateDBInstanceResultTypeDef](./type_defs.md#createdbinstanceresulttypedef)
...
def create_db_instance_read_replica(
    ...
    *,
    ...
    AdditionalStorageVolumes: Sequence[AdditionalStorageVolumeTypeDef] = ...,  # (5)
    SourceRegion: str = ...,
) -> CreateDBInstanceReadReplicaResultTypeDef:  # (6)
    ...
```
...
5. See `Sequence[AdditionalStorageVolumeTypeDef]`
6. See [:material-code-braces: CreateDBInstanceReadReplicaResultTypeDef](./type_defs.md#createdbinstancereadreplicaresulttypedef)
...
def modify_db_instance(
    ...
    *,
    ...
    AdditionalStorageVolumes: Sequence[ModifyAdditionalStorageVolumeTypeDef] = ...,  # (7)
) -> ModifyDBInstanceResultTypeDef:  # (8)
    ...
```
...
7. See `Sequence[ModifyAdditionalStorageVolumeTypeDef]`
8. See [:material-code-braces: ModifyDBInstanceResultTypeDef](./type_defs.md#modifydbinstanceresulttypedef)
...
) -> RestoreDBInstanceFromDBSnapshotResultTypeDef:  # (4)
    ...
```
...
4. See [:material-code-braces: RestoreDBInstanceFromDBSnapshotResultTypeDef](./type_defs.md#restoredbinstancefromdbsnapshotresulttypedef)
...
) -> RestoreDBInstanceFromS3ResultTypeDef:  # (5)
    ...
```
...
5. See [:material-code-braces: RestoreDBInstanceFromS3ResultTypeDef](./type_defs.md#restoredbinstancefroms3resulttypedef)
...
def restore_db_instance_to_point_in_time(
    ...
    *,
    ...
    MasterUserSecretKmsKeyId: str = ...,
    AdditionalStorageVolumes: Sequence[AdditionalStorageVolumeTypeDef] = ...,  # (3)
) -> RestoreDBInstanceToPointInTimeResultTypeDef:  # (4)
    ...
```
...
2. See `Sequence[ProcessorFeatureTypeDef]`
3. See `Sequence[AdditionalStorageVolumeTypeDef]`
4. See [:material-code-braces: RestoreDBInstanceToPointInTimeResultTypeDef](./type_defs.md#restoredbinstancetopointintimeresulttypedef)
