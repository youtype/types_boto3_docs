...
def paginate(
    ...
    *,
    ...
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[DBClusterAutomatedBackupMessageTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[DBRecommendationsMessageTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    DbiResourceId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[DBSnapshotTenantDatabasesMessageTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[DescribeIntegrationsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[TenantDatabasesMessageTypeDef]:  # (3)
    ...
```
