...
) -> PageIterator[ListIdentityProvidersResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListInstancesResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListLicenseServerEndpointsResponseTypeDef]:  # (3)
    ...
```
...
) -> PageIterator[ListProductSubscriptionsResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Filters: Sequence[FilterTypeDef] = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> PageIterator[ListUserAssociationsResponseTypeDef]:  # (4)
    ...
```
