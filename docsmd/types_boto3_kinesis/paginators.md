...
) -> PageIterator[DescribeStreamOutputTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListShardsOutputTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    StreamCreationTimestamp: TimestampTypeDef = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListStreamConsumersOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListStreamsOutputTypeDef]:  # (2)
    ...
```
