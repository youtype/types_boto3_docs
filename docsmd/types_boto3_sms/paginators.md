...
3. item: `PageIterator[GetConnectorsResponseTypeDef]`
...
) -> botocore.paginate.PageIterator[GetConnectorsResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `PageIterator[GetConnectorsResponseTypeDef]`
...
3. item: `PageIterator[GetReplicationJobsResponseTypeDef]`
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> botocore.paginate.PageIterator[GetReplicationJobsResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `PageIterator[GetReplicationJobsResponseTypeDef]`
...
3. item: `PageIterator[GetReplicationRunsResponseTypeDef]`
...
def paginate(
    ...
    *,
    replicationJobId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> botocore.paginate.PageIterator[GetReplicationRunsResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `PageIterator[GetReplicationRunsResponseTypeDef]`
...
3. item: `PageIterator[GetServersResponseTypeDef]`
...
) -> botocore.paginate.PageIterator[GetServersResponseTypeDef]:  # (3)
    ...
```

1. See `Sequence[VmServerAddressTypeDef]`
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
3. See `PageIterator[GetServersResponseTypeDef]`
