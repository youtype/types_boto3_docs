...
) -> _PageIterator[ListConnectionsOutputTypeDef]:  # (5)
    ...
```
...
) -> _PageIterator[ListJobRunsOutputTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> _PageIterator[ListLineageEventsOutputTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    sortOrder: SortOrderType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> _PageIterator[ListProjectProfilesOutputTypeDef]:  # (4)
    ...
```
