...
) -> botocore.paginate.PageIterator[ListConnectionsOutputTypeDef]:  # (5)
    ...
```
...
5. See `PageIterator[ListConnectionsOutputTypeDef]`
...
) -> botocore.paginate.PageIterator[SearchListingsOutputTypeDef]:  # (6)
    ...
```
...
6. See `PageIterator[SearchListingsOutputTypeDef]`
