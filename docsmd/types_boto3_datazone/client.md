...
def accept_subscription_request(
    ...
    *,
    domainIdentifier: str,
    identifier: str,
    assetPermissions: Sequence[AssetPermissionTypeDef] = ...,  # (1)
    assetScopes: Sequence[AcceptedAssetScopeTypeDef] = ...,  # (2)
    decisionComment: str = ...,
...
def create_subscription_request(
    ...
    *,
    ...
    assetPermissions: Sequence[AssetPermissionTypeDef] = ...,  # (3)
    assetScopes: Sequence[AcceptedAssetScopeTypeDef] = ...,  # (4)
    clientToken: str = ...,
    metadataForms: Sequence[FormInputTypeDef] = ...,  # (5)
