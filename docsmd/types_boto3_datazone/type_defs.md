...
class ListConnectionsInputTypeDef(TypedDict):
    ...
    scope: NotRequired[ConnectionScopeType],  # (1)
    sortBy: NotRequired[SortFieldConnectionType],  # (2)
    sortOrder: NotRequired[SortOrderType],  # (3)
    type: NotRequired[ConnectionTypeType],  # (4)
```

1. See [:material-code-brackets: ConnectionScopeType](./literals.md#connectionscopetype)
...
class BatchPutAttributesMetadataOutputTypeDef(TypedDict):
    attributes: list[BatchPutAttributeOutputTypeDef],  # (1)
    errors: list[AttributeErrorTypeDef],  # (2)
    ResponseMetadata: ResponseMetadataTypeDef,  # (3)
```

1. See `list[BatchPutAttributeOutputTypeDef]`
...
class GetMetadataGenerationRunOutputTypeDef(TypedDict):
    ...
    typeStats: list[MetadataGenerationRunTypeStatTypeDef],  # (4)
    types: list[MetadataGenerationRunTypeType],  # (5)
    ResponseMetadata: ResponseMetadataTypeDef,  # (6)
```
...
2. See [:material-code-braces: MetadataGenerationRunTargetTypeDef](./type_defs.md#metadatagenerationruntargettypedef)
3. See [:material-code-brackets: MetadataGenerationRunTypeType](./literals.md#metadatagenerationruntypetype)
4. See `list[MetadataGenerationRunTypeStatTypeDef]`
5. See `list[MetadataGenerationRunTypeType]`
6. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
class SubscribedAssetTypeDef(TypedDict):
    assetId: str,
    assetRevision: str,
    status: SubscriptionGrantStatusType,  # (4)
    assetScope: NotRequired[AssetScopeTypeDef],  # (1)
    failureCause: NotRequired[FailureCauseTypeDef],  # (2)
...
2. See [:material-code-braces: FailureCauseTypeDef](./type_defs.md#failurecausetypedef)
3. See [:material-code-braces: PermissionsOutputTypeDef](./type_defs.md#permissionsoutputtypedef)
4. See [:material-code-brackets: SubscriptionGrantStatusType](./literals.md#subscriptiongrantstatustype)
...
class SubscribedPrincipalInputTypeDef(TypedDict):
    group: NotRequired[SubscribedGroupInputTypeDef],  # (1)
    project: NotRequired[SubscribedProjectInputTypeDef],  # (2)
    user: NotRequired[SubscribedUserInputTypeDef],  # (3)
```

1. See [:material-code-braces: SubscribedGroupInputTypeDef](./type_defs.md#subscribedgroupinputtypedef)
2. See [:material-code-braces: SubscribedProjectInputTypeDef](./type_defs.md#subscribedprojectinputtypedef)
3. See [:material-code-braces: SubscribedUserInputTypeDef](./type_defs.md#subscribeduserinputtypedef)
...
class BatchPutAttributesMetadataInputTypeDef(TypedDict):
    attributes: Sequence[AttributeInputTypeDef],  # (1)
    domainIdentifier: str,
    entityIdentifier: str,
    entityType: AttributeEntityTypeType,  # (2)
    clientToken: NotRequired[str],
```

1. See `Sequence[AttributeInputTypeDef]`
2. See [:material-code-brackets: AttributeEntityTypeType](./literals.md#attributeentitytypetype)
...
class CreateProjectOutputTypeDef(TypedDict):
    ...
    userParameters: list[EnvironmentConfigurationUserParameterOutputTypeDef],  # (5)
    ResponseMetadata: ResponseMetadataTypeDef,  # (6)
```
...
5. See `list[EnvironmentConfigurationUserParameterOutputTypeDef]`
6. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
class RuleDetailOutputTypeDef(TypedDict):
    glossaryTermEnforcementDetail: NotRequired[GlossaryTermEnforcementDetailOutputTypeDef],  # (1)
    metadataFormEnforcementDetail: NotRequired[MetadataFormEnforcementDetailOutputTypeDef],  # (2)
```

1. See [:material-code-braces: GlossaryTermEnforcementDetailOutputTypeDef](./type_defs.md#glossarytermenforcementdetailoutputtypedef)
...
class RuleDetailTypeDef(TypedDict):
    glossaryTermEnforcementDetail: NotRequired[GlossaryTermEnforcementDetailTypeDef],  # (1)
    metadataFormEnforcementDetail: NotRequired[MetadataFormEnforcementDetailTypeDef],  # (2)
```

1. See [:material-code-braces: GlossaryTermEnforcementDetailTypeDef](./type_defs.md#glossarytermenforcementdetailtypedef)
2. See [:material-code-braces: MetadataFormEnforcementDetailTypeDef](./type_defs.md#metadataformenforcementdetailtypedef)
...
class AcceptSubscriptionRequestInputTypeDef(TypedDict):
    domainIdentifier: str,
    identifier: str,
    assetPermissions: NotRequired[Sequence[AssetPermissionTypeDef]],  # (1)
    assetScopes: NotRequired[Sequence[AcceptedAssetScopeTypeDef]],  # (2)
    decisionComment: NotRequired[str],
```

1. See `Sequence[AssetPermissionTypeDef]`
2. See `Sequence[AcceptedAssetScopeTypeDef]`
...
class CreateSubscriptionRequestInputTypeDef(TypedDict):
    ...
    assetPermissions: NotRequired[Sequence[AssetPermissionTypeDef]],  # (3)
    assetScopes: NotRequired[Sequence[AcceptedAssetScopeTypeDef]],  # (4)
    clientToken: NotRequired[str],
    metadataForms: NotRequired[Sequence[FormInputTypeDef]],  # (5)
```

1. See `Sequence[SubscribedListingInputTypeDef]`
2. See `Sequence[SubscribedPrincipalInputTypeDef]`
3. See `Sequence[AssetPermissionTypeDef]`
4. See `Sequence[AcceptedAssetScopeTypeDef]`
...
class ConnectionPropertiesOutputTypeDef(TypedDict):
    amazonQProperties: NotRequired[AmazonQPropertiesOutputTypeDef],  # (1)
    athenaProperties: NotRequired[AthenaPropertiesOutputTypeDef],  # (2)
    glueProperties: NotRequired[GluePropertiesOutputTypeDef],  # (3)
    hyperPodProperties: NotRequired[HyperPodPropertiesOutputTypeDef],  # (4)
    iamProperties: NotRequired[IamPropertiesOutputTypeDef],  # (5)
    mlflowProperties: NotRequired[MlflowPropertiesOutputTypeDef],  # (6)
    redshiftProperties: NotRequired[RedshiftPropertiesOutputTypeDef],  # (7)
    s3Properties: NotRequired[S3PropertiesOutputTypeDef],  # (8)
    sparkEmrProperties: NotRequired[SparkEmrPropertiesOutputTypeDef],  # (9)
    sparkGlueProperties: NotRequired[SparkGluePropertiesOutputTypeDef],  # (10)
```

1. See [:material-code-braces: AmazonQPropertiesOutputTypeDef](./type_defs.md#amazonqpropertiesoutputtypedef)
2. See [:material-code-braces: AthenaPropertiesOutputTypeDef](./type_defs.md#athenapropertiesoutputtypedef)
3. See [:material-code-braces: GluePropertiesOutputTypeDef](./type_defs.md#gluepropertiesoutputtypedef)
4. See [:material-code-braces: HyperPodPropertiesOutputTypeDef](./type_defs.md#hyperpodpropertiesoutputtypedef)
5. See [:material-code-braces: IamPropertiesOutputTypeDef](./type_defs.md#iampropertiesoutputtypedef)
6. See [:material-code-braces: MlflowPropertiesOutputTypeDef](./type_defs.md#mlflowpropertiesoutputtypedef)
7. See [:material-code-braces: RedshiftPropertiesOutputTypeDef](./type_defs.md#redshiftpropertiesoutputtypedef)
8. See [:material-code-braces: S3PropertiesOutputTypeDef](./type_defs.md#s3propertiesoutputtypedef)
9. See [:material-code-braces: SparkEmrPropertiesOutputTypeDef](./type_defs.md#sparkemrpropertiesoutputtypedef)
10. See [:material-code-braces: SparkGluePropertiesOutputTypeDef](./type_defs.md#sparkgluepropertiesoutputtypedef)
...
class SubscribedPrincipalTypeDef(TypedDict):
    group: NotRequired[SubscribedGroupTypeDef],  # (1)
    project: NotRequired[SubscribedProjectTypeDef],  # (2)
    user: NotRequired[SubscribedUserTypeDef],  # (3)
```

1. See [:material-code-braces: SubscribedGroupTypeDef](./type_defs.md#subscribedgrouptypedef)
2. See [:material-code-braces: SubscribedProjectTypeDef](./type_defs.md#subscribedprojecttypedef)
3. See [:material-code-braces: SubscribedUserTypeDef](./type_defs.md#subscribedusertypedef)
...
class ConnectionPropertiesPatchTypeDef(TypedDict):
    amazonQProperties: NotRequired[AmazonQPropertiesPatchTypeDef],  # (1)
    athenaProperties: NotRequired[AthenaPropertiesPatchTypeDef],  # (2)
    glueProperties: NotRequired[GluePropertiesPatchTypeDef],  # (3)
    iamProperties: NotRequired[IamPropertiesPatchTypeDef],  # (4)
    mlflowProperties: NotRequired[MlflowPropertiesPatchTypeDef],  # (5)
    redshiftProperties: NotRequired[RedshiftPropertiesPatchTypeDef],  # (6)
    s3Properties: NotRequired[S3PropertiesPatchTypeDef],  # (7)
    sparkEmrProperties: NotRequired[SparkEmrPropertiesPatchTypeDef],  # (8)
```

1. See [:material-code-braces: AmazonQPropertiesPatchTypeDef](./type_defs.md#amazonqpropertiespatchtypedef)
2. See [:material-code-braces: AthenaPropertiesPatchTypeDef](./type_defs.md#athenapropertiespatchtypedef)
3. See [:material-code-braces: GluePropertiesPatchTypeDef](./type_defs.md#gluepropertiespatchtypedef)
4. See [:material-code-braces: IamPropertiesPatchTypeDef](./type_defs.md#iampropertiespatchtypedef)
5. See [:material-code-braces: MlflowPropertiesPatchTypeDef](./type_defs.md#mlflowpropertiespatchtypedef)
6. See [:material-code-braces: RedshiftPropertiesPatchTypeDef](./type_defs.md#redshiftpropertiespatchtypedef)
7. See [:material-code-braces: S3PropertiesPatchTypeDef](./type_defs.md#s3propertiespatchtypedef)
8. See [:material-code-braces: SparkEmrPropertiesPatchTypeDef](./type_defs.md#sparkemrpropertiespatchtypedef)
...
class ConnectionPropertiesInputTypeDef(TypedDict):
    amazonQProperties: NotRequired[AmazonQPropertiesInputTypeDef],  # (1)
    athenaProperties: NotRequired[AthenaPropertiesInputTypeDef],  # (2)
    glueProperties: NotRequired[GluePropertiesInputTypeDef],  # (3)
    hyperPodProperties: NotRequired[HyperPodPropertiesInputTypeDef],  # (4)
    iamProperties: NotRequired[IamPropertiesInputTypeDef],  # (5)
    mlflowProperties: NotRequired[MlflowPropertiesInputTypeDef],  # (6)
    redshiftProperties: NotRequired[RedshiftPropertiesInputTypeDef],  # (7)
    s3Properties: NotRequired[S3PropertiesInputTypeDef],  # (8)
    sparkEmrProperties: NotRequired[SparkEmrPropertiesInputTypeDef],  # (9)
    sparkGlueProperties: NotRequired[SparkGluePropertiesInputTypeDef],  # (10)
```

1. See [:material-code-braces: AmazonQPropertiesInputTypeDef](./type_defs.md#amazonqpropertiesinputtypedef)
2. See [:material-code-braces: AthenaPropertiesInputTypeDef](./type_defs.md#athenapropertiesinputtypedef)
3. See [:material-code-braces: GluePropertiesInputTypeDef](./type_defs.md#gluepropertiesinputtypedef)
4. See [:material-code-braces: HyperPodPropertiesInputTypeDef](./type_defs.md#hyperpodpropertiesinputtypedef)
5. See [:material-code-braces: IamPropertiesInputTypeDef](./type_defs.md#iampropertiesinputtypedef)
6. See [:material-code-braces: MlflowPropertiesInputTypeDef](./type_defs.md#mlflowpropertiesinputtypedef)
7. See [:material-code-braces: RedshiftPropertiesInputTypeDef](./type_defs.md#redshiftpropertiesinputtypedef)
8. See [:material-code-braces: S3PropertiesInputTypeDef](./type_defs.md#s3propertiesinputtypedef)
9. See [:material-code-braces: SparkEmrPropertiesInputTypeDef](./type_defs.md#sparkemrpropertiesinputtypedef)
10. See [:material-code-braces: SparkGluePropertiesInputTypeDef](./type_defs.md#sparkgluepropertiesinputtypedef)
