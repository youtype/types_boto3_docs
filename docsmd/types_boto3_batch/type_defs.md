...
class DescribeServiceJobResponseTypeDef(TypedDict):
    ...
    shareIdentifier: str,
    startedAt: int,
    status: ServiceJobStatusType,  # (6)
    statusReason: str,
    stoppedAt: int,
    tags: dict[str, str],
    timeoutConfig: ServiceJobTimeoutTypeDef,  # (7)
...
6. See [:material-code-brackets: ServiceJobStatusType](./literals.md#servicejobstatustype)
7. See [:material-code-braces: ServiceJobTimeoutTypeDef](./type_defs.md#servicejobtimeouttypedef)
...
class GetJobQueueSnapshotResponseTypeDef(TypedDict):
    ...
    queueUtilization: QueueSnapshotUtilizationDetailTypeDef,  # (2)
    ResponseMetadata: ResponseMetadataTypeDef,  # (3)
```

1. See [:material-code-braces: FrontOfQueueDetailTypeDef](./type_defs.md#frontofqueuedetailtypedef)
2. See [:material-code-braces: QueueSnapshotUtilizationDetailTypeDef](./type_defs.md#queuesnapshotutilizationdetailtypedef)
