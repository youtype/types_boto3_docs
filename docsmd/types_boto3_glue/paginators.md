...
) -> _PageIterator[DescribeEntityResponseTypeDef]:  # (2)
    ...
```
...
) -> _PageIterator[GetDatabasesResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[GetJobsResponsePaginatorTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    CatalogId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[GetTableVersionsResponsePaginatorTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[GetTablesResponsePaginatorTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    IncludeGraph: bool = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[GetWorkflowRunsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListBlueprintsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListConnectionTypesResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    DataStoreApiVersion: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListEntitiesResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[ListTableOptimizerRunsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Tags: Mapping[str, str] = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListTriggersResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListUsageProfilesResponseTypeDef]:  # (2)
    ...
```
