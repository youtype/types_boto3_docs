...
) -> PageIterator[DescribeAccountModificationsResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[DescribeIpGroupsResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Owner: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[DescribeWorkspaceBundlesResultTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[DescribeWorkspaceDirectoriesResultTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[DescribeWorkspaceImagesResultTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[DescribeWorkspacesConnectionStatusResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    WorkspaceName: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[DescribeWorkspacesResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListAccountLinksResultTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListAvailableManagementCidrRangesResultTypeDef]:  # (2)
    ...
```
