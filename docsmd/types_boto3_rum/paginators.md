...
) -> PageIterator[BatchGetRumMetricDefinitionsResponseTypeDef]:  # (3)
    ...
```
...
) -> PageIterator[GetAppMonitorDataResponseTypeDef]:  # (4)
    ...
```
...
) -> PageIterator[ListAppMonitorsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    AppMonitorName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListRumMetricsDestinationsResponseTypeDef]:  # (2)
    ...
```
