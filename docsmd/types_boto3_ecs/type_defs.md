...
class ServiceRevisionTypeDef(TypedDict):
    ...
    monitoring: NotRequired[MonitoringConfigurationOutputTypeDef],  # (13)
```
...
13. See [:material-code-braces: MonitoringConfigurationOutputTypeDef](./type_defs.md#monitoringconfigurationoutputtypedef)
