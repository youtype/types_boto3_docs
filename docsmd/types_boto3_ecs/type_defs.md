...
class InstanceLaunchTemplateUpdateTypeDef(TypedDict):
    ...
    capacityReservations: NotRequired[CapacityReservationRequestTypeDef],  # (5)
```
...
5. See [:material-code-braces: CapacityReservationRequestTypeDef](./type_defs.md#capacityreservationrequesttypedef)
