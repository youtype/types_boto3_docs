...
result = client.batch_create_billing_adjustment_request()  # (2)
```

1. client: [AgreementServiceClient](./client.md)
2. result: [:material-code-braces: BatchCreateBillingAdjustmentRequestOutputTypeDef](./type_defs.md#batchcreatebillingadjustmentrequestoutputtypedef)
...
paginator = client.get_paginator("list_agreement_cancellation_requests")  # (2)
...
3. item: [:material-code-braces: ListAgreementCancellationRequestsOutputTypeDef](./type_defs.md#listagreementcancellationrequestsoutputtypedef)
...
kwargs: BatchCreateBillingAdjustmentRequestInputTypeDef = {...}
result: BatchCreateBillingAdjustmentRequestOutputTypeDef = client.batch_create_billing_adjustment_request(**kwargs)
```
...
paginator: ListAgreementCancellationRequestsPaginator = client.get_paginator("list_agreement_cancellation_requests")
for item in paginator.paginate(...):
