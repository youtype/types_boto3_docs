...
) -> PageIterator[GetOutpostInstanceTypesOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    OrderId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[GetOutpostSupportedInstanceTypesOutputTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListAssetInstancesOutputTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListAssetsOutputTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    CapacityTaskId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListBlockingInstancesForCapacityTaskOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListCapacityTasksOutputTypeDef]:  # (3)
    ...
```
...
) -> PageIterator[ListCatalogItemsOutputTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    OutpostIdentifierFilter: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListOrdersOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListOutpostsOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListSitesOutputTypeDef]:  # (2)
    ...
```
