...
) -> PageIterator[ListAssociatedRoute53HealthChecksResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ClusterArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListControlPanelsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ControlPanelArn: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListRoutingControlsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ControlPanelArn: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListSafetyRulesResponseTypeDef]:  # (2)
    ...
```
