...
5. See [:material-code-braces: CreateEventOutputTypeDef](./type_defs.md#createeventoutputtypedef)
...
def start_batch_evaluation(
    ...
    *,
    ...
    kmsKeyArn: str = ...,
    description: str = ...,
) -> StartBatchEvaluationResponseTypeDef:  # (5)
    ...
```
...
5. See [:material-code-braces: StartBatchEvaluationResponseTypeDef](./type_defs.md#startbatchevaluationresponsetypedef)
