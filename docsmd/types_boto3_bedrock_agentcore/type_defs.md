...
class GetBrowserSessionResponseTypeDef(TypedDict):
    ...
    sessionTimeoutSeconds: int,
    status: BrowserSessionStatusType,  # (3)
    streams: BrowserSessionStreamTypeDef,  # (4)
...
3. See [:material-code-brackets: BrowserSessionStatusType](./literals.md#browsersessionstatustype)
4. See [:material-code-braces: BrowserSessionStreamTypeDef](./type_defs.md#browsersessionstreamtypedef)
