...
from types_boto3_connectparticipant.type_defs import MediaPlacementTypeDef
...
from types_boto3_connectparticipant.type_defs import MeetingTypeDef
...
from types_boto3_connectparticipant.type_defs import ConnectionDataTypeDef
...
class CreateParticipantConnectionResponseTypeDef(TypedDict):
    ...
    WebRTCConnection: ConnectionDataTypeDef,  # (3)
...
3. See [:material-code-braces: ConnectionDataTypeDef](./type_defs.md#connectiondatatypedef)
