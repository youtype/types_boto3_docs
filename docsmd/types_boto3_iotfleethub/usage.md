...
With `types-boto3-lite[iotfleethub]`
or a standalone `types_boto3_iotfleethub` package, you have to explicitly specify `client: IoTFleetHubClient` type annotation.
...
from types_boto3_iotfleethub.type_defs import CreateApplicationRequestRequestTypeDef
