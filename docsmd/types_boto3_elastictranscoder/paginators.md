...
) -> PageIterator[ListJobsByPipelineResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Ascending: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListJobsByStatusResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    Ascending: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListPipelinesResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    Ascending: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListPresetsResponseTypeDef]:  # (2)
    ...
```
