...
) -> _PageIterator[ListServiceDependenciesOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    KeyAttributes: Mapping[str, str],
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListServiceDependentsOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    OperationName: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListServiceLevelObjectivesOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    KeyAttributes: Mapping[str, str],
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListServiceOperationsOutputTypeDef]:  # (2)
    ...
```
