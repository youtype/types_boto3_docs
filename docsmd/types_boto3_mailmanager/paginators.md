...
def paginate(
    ...
    *,
    AddressListId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListAddressListImportJobsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListAddressListsResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListMembersOfAddressListResponseTypeDef]:  # (3)
    ...
```
