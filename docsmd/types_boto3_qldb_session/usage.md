...
Can be used with `types-boto3[qldb-session]` package installed.
...
or a standalone `types_boto3_qldb_session` package, you have to explicitly specify `client: QLDBSessionClient` type annotation.
...
from types_boto3_qldb_session.type_defs import SendCommandRequestRequestTypeDef
