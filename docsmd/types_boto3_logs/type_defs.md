...
from types_boto3_logs.type_defs import DestinationConfigurationUnionTypeDef
...
from types_boto3_logs.type_defs import GroupingIdentifierTypeDef
...
from types_boto3_logs.type_defs import DataSourceTypeDef
...
from types_boto3_logs.type_defs import CancelImportTaskRequestTypeDef
...
from types_boto3_logs.type_defs import ImportStatisticsTypeDef
...
from types_boto3_logs.type_defs import DeliverySourceConfigurationSchemaTypeDef
...
from types_boto3_logs.type_defs import S3TablesIntegrationTypeDef
...
from types_boto3_logs.type_defs import ImportFilterTypeDef
...
from types_boto3_logs.type_defs import CreateLookupTableRequestTypeDef
...
from types_boto3_logs.type_defs import DataSourceFilterTypeDef
...
from types_boto3_logs.type_defs import DeleteLookupTableRequestTypeDef
...
from types_boto3_logs.type_defs import DeleteScheduledQueryRequestTypeDef
...
```python
# DeleteSyslogConfigurationRequestTypeDef TypedDict usage example

from types_boto3_logs.type_defs import DeleteSyslogConfigurationRequestTypeDef


def get_value() -> DeleteSyslogConfigurationRequestTypeDef:
    return {
        "logGroupIdentifier": ...,
    }


# DeleteSyslogConfigurationRequestTypeDef definition
...
class DescribeFieldIndexesRequestTypeDef(TypedDict):
    ...
    indexCategories: NotRequired[Sequence[IndexCategoryType]],  # (1)
    nextToken: NotRequired[str],
```
...
class FieldIndexTypeDef(TypedDict):
    ...
    indexCategory: NotRequired[IndexCategoryType],  # (2)
```

1. See [:material-code-brackets: IndexTypeType](./literals.md#indextypetype)
2. See [:material-code-brackets: IndexCategoryType](./literals.md#indexcategorytype)
...
from types_boto3_logs.type_defs import DescribeImportTaskBatchesRequestTypeDef
...
from types_boto3_logs.type_defs import ImportBatchTypeDef
...
from types_boto3_logs.type_defs import DescribeImportTasksRequestTypeDef
...
from types_boto3_logs.type_defs import DescribeLookupTablesRequestTypeDef
...
from types_boto3_logs.type_defs import LookupTableTypeDef
...
```python
# LookupTableConfigurationOutputTypeDef TypedDict usage example

from types_boto3_logs.type_defs import LookupTableConfigurationOutputTypeDef


def get_value() -> LookupTableConfigurationOutputTypeDef:
    return {
        "tableName": ...,
    }


# LookupTableConfigurationOutputTypeDef definition
...
from types_boto3_logs.type_defs import S3ConfigurationTypeDef
...
```python
# LookupTableConfigurationTypeDef TypedDict usage example

from types_boto3_logs.type_defs import LookupTableConfigurationTypeDef


def get_value() -> LookupTableConfigurationTypeDef:
    return {
        "tableName": ...,
    }


# LookupTableConfigurationTypeDef definition
...
from types_boto3_logs.type_defs import DisassociateSourceFromS3TableIntegrationRequestTypeDef
...
from types_boto3_logs.type_defs import GetLogFieldsRequestTypeDef
...
from types_boto3_logs.type_defs import GetLookupTableRequestTypeDef
...
from types_boto3_logs.type_defs import GetScheduledQueryHistoryRequestTypeDef
...
from types_boto3_logs.type_defs import GetScheduledQueryRequestTypeDef
...
from types_boto3_logs.type_defs import TagFilterTypeDef
...
from types_boto3_logs.type_defs import ListScheduledQueriesRequestTypeDef
...
from types_boto3_logs.type_defs import ListSourcesForS3TableIntegrationRequestTypeDef
...
```python
# ListSyslogConfigurationsRequestTypeDef TypedDict usage example

from types_boto3_logs.type_defs import ListSyslogConfigurationsRequestTypeDef


def get_value() -> ListSyslogConfigurationsRequestTypeDef:
    return {
        "logGroupIdentifier": ...,
    }


# ListSyslogConfigurationsRequestTypeDef definition
...
```python
# SyslogConfigurationTypeDef TypedDict usage example

from types_boto3_logs.type_defs import SyslogConfigurationTypeDef


def get_value() -> SyslogConfigurationTypeDef:
    return {
        "logGroupArn": ...,
    }


# SyslogConfigurationTypeDef definition

class SyslogConfigurationTypeDef(TypedDict):
    logGroupArn: NotRequired[str],
    sourceType: NotRequired[SyslogSourceTypeType],  # (1)
    vpcEndpointId: NotRequired[str],
    createdAt: NotRequired[int],
```

1. See [:material-code-brackets: SyslogSourceTypeType](./literals.md#syslogsourcetypetype)
...
from types_boto3_logs.type_defs import LogFieldTypeTypeDef
...
from types_boto3_logs.type_defs import PutBearerTokenAuthenticationRequestTypeDef
...
from types_boto3_logs.type_defs import PutLogGroupDeletionProtectionRequestTypeDef
...
from types_boto3_logs.type_defs import QueryParameterTypeDef
...
```python
# PutStorageTierPolicyRequestTypeDef TypedDict usage example

from types_boto3_logs.type_defs import PutStorageTierPolicyRequestTypeDef


def get_value() -> PutStorageTierPolicyRequestTypeDef:
    return {
        "storageTier": ...,
    }


# PutStorageTierPolicyRequestTypeDef definition
...
```python
# PutSyslogConfigurationRequestTypeDef TypedDict usage example

from types_boto3_logs.type_defs import PutSyslogConfigurationRequestTypeDef


def get_value() -> PutSyslogConfigurationRequestTypeDef:
    return {
        "logGroupIdentifier": ...,
    }


# PutSyslogConfigurationRequestTypeDef definition
...
from types_boto3_logs.type_defs import ScheduledQueryDestinationTypeDef
...
from types_boto3_logs.type_defs import UpdateLookupTableRequestTypeDef
...
from types_boto3_logs.type_defs import AggregateLogGroupSummaryTypeDef
...
from types_boto3_logs.type_defs import AssociateSourceToS3TableIntegrationRequestTypeDef
...
from types_boto3_logs.type_defs import S3TableIntegrationSourceTypeDef
...
from types_boto3_logs.type_defs import AssociateSourceToS3TableIntegrationResponseTypeDef
...
from types_boto3_logs.type_defs import CreateImportTaskResponseTypeDef
...
from types_boto3_logs.type_defs import CreateLookupTableResponseTypeDef
...
from types_boto3_logs.type_defs import CreateScheduledQueryResponseTypeDef
...
from types_boto3_logs.type_defs import DisassociateSourceFromS3TableIntegrationResponseTypeDef
...
from types_boto3_logs.type_defs import GetLookupTableResponseTypeDef
...
```python
# GetStorageTierPolicyResponseTypeDef TypedDict usage example

from types_boto3_logs.type_defs import GetStorageTierPolicyResponseTypeDef


def get_value() -> GetStorageTierPolicyResponseTypeDef:
    return {
        "storageTier": ...,
    }


# GetStorageTierPolicyResponseTypeDef definition
...
```python
# PutStorageTierPolicyResponseTypeDef TypedDict usage example

from types_boto3_logs.type_defs import PutStorageTierPolicyResponseTypeDef


def get_value() -> PutStorageTierPolicyResponseTypeDef:
    return {
        "storageTier": ...,
    }


# PutStorageTierPolicyResponseTypeDef definition
...
from types_boto3_logs.type_defs import UpdateLookupTableResponseTypeDef
...
from types_boto3_logs.type_defs import CancelImportTaskResponseTypeDef
...
from types_boto3_logs.type_defs import CreateImportTaskRequestTypeDef
...
from types_boto3_logs.type_defs import ImportTypeDef
...
from types_boto3_logs.type_defs import ListAggregateLogGroupSummariesRequestTypeDef
...
from types_boto3_logs.type_defs import GetScheduledQueryHistoryRequestPaginateTypeDef
...
from types_boto3_logs.type_defs import ListAggregateLogGroupSummariesRequestPaginateTypeDef
...
from types_boto3_logs.type_defs import ListScheduledQueriesRequestPaginateTypeDef
...
from types_boto3_logs.type_defs import ListSourcesForS3TableIntegrationRequestPaginateTypeDef
...
from types_boto3_logs.type_defs import DescribeImportTaskBatchesResponseTypeDef
...
from types_boto3_logs.type_defs import DescribeLookupTablesResponseTypeDef
...
from types_boto3_logs.type_defs import DestinationConfigurationOutputTypeDef
...
class DestinationConfigurationOutputTypeDef(TypedDict):
    ...
    lookupTableConfiguration: NotRequired[LookupTableConfigurationOutputTypeDef],  # (2)
```

1. See [:material-code-braces: S3ConfigurationTypeDef](./type_defs.md#s3configurationtypedef)
2. See [:material-code-braces: LookupTableConfigurationOutputTypeDef](./type_defs.md#lookuptableconfigurationoutputtypedef)
...
from types_boto3_logs.type_defs import DestinationConfigurationTypeDef
...
class DestinationConfigurationTypeDef(TypedDict):
    s3Configuration: NotRequired[S3ConfigurationTypeDef],  # (1)
    lookupTableConfiguration: NotRequired[LookupTableConfigurationTypeDef],  # (2)
```

1. See [:material-code-braces: S3ConfigurationTypeDef](./type_defs.md#s3configurationtypedef)
2. See [:material-code-braces: LookupTableConfigurationTypeDef](./type_defs.md#lookuptableconfigurationtypedef)
...
from types_boto3_logs.type_defs import GetLogObjectResponseStreamTypeDef
...
from types_boto3_logs.type_defs import ListLogGroupsResponseTypeDef
...
```python
# ListSyslogConfigurationsResponseTypeDef TypedDict usage example

from types_boto3_logs.type_defs import ListSyslogConfigurationsResponseTypeDef


def get_value() -> ListSyslogConfigurationsResponseTypeDef:
    return {
        "syslogConfigurations": ...,
    }


# ListSyslogConfigurationsResponseTypeDef definition

class ListSyslogConfigurationsResponseTypeDef(TypedDict):
    syslogConfigurations: list[SyslogConfigurationTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[SyslogConfigurationTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_boto3_logs.type_defs import LogFieldsListItemTypeDef
...
from types_boto3_logs.type_defs import TriggerHistoryRecordTypeDef
...
from types_boto3_logs.type_defs import ListAggregateLogGroupSummariesResponseTypeDef
...
from types_boto3_logs.type_defs import ListSourcesForS3TableIntegrationResponseTypeDef
...
from types_boto3_logs.type_defs import DescribeImportTasksResponseTypeDef
...
from types_boto3_logs.type_defs import GetScheduledQueryResponseTypeDef
...
class GetScheduledQueryResponseTypeDef(TypedDict):
    ...
    startTimeOffset: int,
    endTimeOffset: int,
    destinationConfiguration: DestinationConfigurationOutputTypeDef,  # (2)
    state: ScheduledQueryStateType,  # (3)
    scheduleType: ScheduleTypeType,  # (4)
    lastTriggeredTime: int,
    lastExecutionStatus: ExecutionStatusType,  # (5)
...
4. See [:material-code-brackets: ScheduleTypeType](./literals.md#scheduletypetype)
...
from types_boto3_logs.type_defs import ScheduledQuerySummaryTypeDef
...
class ScheduledQuerySummaryTypeDef(TypedDict):
    ...
    lastExecutionStatus: NotRequired[ExecutionStatusType],  # (3)
    scheduleExpression: NotRequired[str],
    timezone: NotRequired[str],
    destinationConfiguration: NotRequired[DestinationConfigurationOutputTypeDef],  # (4)
    creationTime: NotRequired[int],
    lastUpdatedTime: NotRequired[int],
```
...
4. See [:material-code-braces: DestinationConfigurationOutputTypeDef](./type_defs.md#destinationconfigurationoutputtypedef)
...
from types_boto3_logs.type_defs import UpdateScheduledQueryResponseTypeDef
...
from types_boto3_logs.type_defs import GetLogObjectResponseTypeDef
...
class GetLogObjectResponseTypeDef(TypedDict):
    fieldStream: botocore.eventstream.EventStream[GetLogObjectResponseStreamTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See `EventStream[GetLogObjectResponseStreamTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_boto3_logs.type_defs import GetLogFieldsResponseTypeDef
...
from types_boto3_logs.type_defs import GetScheduledQueryHistoryResponseTypeDef
...
from types_boto3_logs.type_defs import ListScheduledQueriesResponseTypeDef
...
from types_boto3_logs.type_defs import CreateScheduledQueryRequestTypeDef
...
class CreateScheduledQueryRequestTypeDef(TypedDict):
    ...
    destinationConfiguration: NotRequired[DestinationConfigurationUnionTypeDef],  # (2)
...
from types_boto3_logs.type_defs import UpdateScheduledQueryRequestTypeDef
...
class StartLiveTailResponseTypeDef(TypedDict):
    responseStream: botocore.eventstream.EventStream[StartLiveTailResponseStreamTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See `EventStream[StartLiveTailResponseStreamTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
