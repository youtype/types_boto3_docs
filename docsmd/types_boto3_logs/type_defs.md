...
class ScheduledQuerySummaryTypeDef(TypedDict):
    ...
    timezone: NotRequired[str],
    destinationConfiguration: NotRequired[DestinationConfigurationTypeDef],  # (4)
    creationTime: NotRequired[int],
    lastUpdatedTime: NotRequired[int],
```
...
4. See [:material-code-braces: DestinationConfigurationTypeDef](./type_defs.md#destinationconfigurationtypedef)
