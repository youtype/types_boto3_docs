...
9. See [:material-code-braces: CreateFHIRDatastoreResponseTypeDef](./type_defs.md#createfhirdatastoreresponsetypedef)
...
def update_fhir_datastore(
    ...
    *,
    DatastoreId: str,
    DatastoreName: str = ...,
    NlpConfiguration: NlpConfigurationTypeDef = ...,  # (1)
...
5. See [:material-code-braces: UpdateFHIRDatastoreResponseTypeDef](./type_defs.md#updatefhirdatastoreresponsetypedef)
