...
class UpdateFHIRDatastoreRequestTypeDef(TypedDict):
    DatastoreId: str,
    DatastoreName: NotRequired[str],
    NlpConfiguration: NotRequired[NlpConfigurationTypeDef],  # (1)
    AnalyticsConfiguration: NotRequired[AnalyticsConfigurationTypeDef],  # (2)
...
1. See [:material-code-braces: NlpConfigurationTypeDef](./type_defs.md#nlpconfigurationtypedef)
