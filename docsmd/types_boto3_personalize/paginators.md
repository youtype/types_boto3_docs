...
) -> PageIterator[ListBatchInferenceJobsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    solutionVersionArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListBatchSegmentJobsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    datasetArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListDatasetExportJobsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    datasetArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListDatasetImportJobsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    datasetGroupArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListEventTrackersResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListMetricAttributionMetricsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    datasetGroupArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListMetricAttributionsResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListRecipesResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    datasetGroupArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListRecommendersResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    solutionArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListSolutionVersionsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    datasetGroupArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListSolutionsResponseTypeDef]:  # (2)
    ...
```
