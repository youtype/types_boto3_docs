...
) -> PageIterator[GetQueryResultsMonitorTopContributorsOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    queryId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[GetQueryResultsWorkloadInsightsTopContributorsDataOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    queryId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[GetQueryResultsWorkloadInsightsTopContributorsOutputTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListMonitorsOutputTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListScopesOutputTypeDef]:  # (2)
    ...
```
