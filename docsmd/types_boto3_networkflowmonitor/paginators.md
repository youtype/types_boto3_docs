...
) -> _PageIterator[GetQueryResultsMonitorTopContributorsOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    queryId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[GetQueryResultsWorkloadInsightsTopContributorsDataOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    queryId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[GetQueryResultsWorkloadInsightsTopContributorsOutputTypeDef]:  # (2)
    ...
```
...
) -> _PageIterator[ListMonitorsOutputTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListScopesOutputTypeDef]:  # (2)
    ...
```
