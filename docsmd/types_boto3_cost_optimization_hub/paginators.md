...
) -> PageIterator[ListEnrollmentStatusesResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListRecommendationSummariesResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> PageIterator[ListRecommendationsResponseTypeDef]:  # (4)
    ...
```
