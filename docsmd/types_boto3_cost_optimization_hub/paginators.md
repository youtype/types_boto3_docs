...
) -> _PageIterator[ListEnrollmentStatusesResponseTypeDef]:  # (2)
    ...
```
...
) -> _PageIterator[ListRecommendationSummariesResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> _PageIterator[ListRecommendationsResponseTypeDef]:  # (4)
    ...
```
