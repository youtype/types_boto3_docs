...
) -> _PageIterator[GetChatControlsConfigurationResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    userId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListAttachmentsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    userId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListConversationsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    applicationId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListDataAccessorsResponseTypeDef]:  # (2)
    ...
```
...
) -> _PageIterator[ListDataSourceSyncJobsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListDocumentsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    pluginId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListPluginActionsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[ListPluginTypeActionsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListPluginTypeMetadataResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    applicationId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListRetrieversResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    applicationId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListWebExperiencesResponseTypeDef]:  # (2)
    ...
```
...
) -> _PageIterator[SearchRelevantContentResponseTypeDef]:  # (4)
    ...
```
