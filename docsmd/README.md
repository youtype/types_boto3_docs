...
Generated with [mypy-boto3-builder 8.10.1](https://github.com/youtype/mypy_boto3_builder).
...
1. Run mypy-boto3-builder in your package root directory: `uvx --with 'boto3==1.37.37' mypy-boto3-builder`
...
- [types-boto3-sms-voice](./types_boto3_sms_voice/README.md) - type annotations for [SMSVoice](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sms-voice.html#smsvoice) service
