...
- [types-boto3-bedrock-agentcore](./types_boto3_bedrock_agentcore/README.md) - type annotations for [BedrockAgentCoreDataPlaneFrontingLayer](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/bedrock-agentcore.html#bedrockagentcoredataplanefrontinglayer) service

- [types-boto3-bedrock-agentcore-control](./types_boto3_bedrock_agentcore_control/README.md) - type annotations for [BedrockAgentCoreControlPlaneFrontingLayer](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/bedrock-agentcore-control.html#bedrockagentcorecontrolplanefrontinglayer) service
