...
) -> PageIterator[GetServerDetailsResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListAnalyzableServersResponseTypeDef]:  # (3)
    ...
```
...
) -> PageIterator[ListApplicationComponentsResponseTypeDef]:  # (5)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListCollectorsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListImportFileTaskResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    sort: SortOrderType = ...,  # (3)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (4)
) -> PageIterator[ListServersResponseTypeDef]:  # (5)
    ...
```
