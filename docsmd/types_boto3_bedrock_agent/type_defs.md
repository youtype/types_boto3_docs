...
class StorageConfigurationTypeDef(TypedDict):
    type: KnowledgeBaseStorageTypeType,  # (7)
    ...
    opensearchServerlessConfiguration: NotRequired[OpenSearchServerlessConfigurationTypeDef],  # (3)
    pineconeConfiguration: NotRequired[PineconeConfigurationTypeDef],  # (4)
    rdsConfiguration: NotRequired[RdsConfigurationTypeDef],  # (5)
    redisEnterpriseCloudConfiguration: NotRequired[RedisEnterpriseCloudConfigurationTypeDef],  # (6)
```
...
3. See [:material-code-braces: OpenSearchServerlessConfigurationTypeDef](./type_defs.md#opensearchserverlessconfigurationtypedef)
...
6. See [:material-code-braces: RedisEnterpriseCloudConfigurationTypeDef](./type_defs.md#redisenterprisecloudconfigurationtypedef)
7. See [:material-code-brackets: KnowledgeBaseStorageTypeType](./literals.md#knowledgebasestoragetypetype)
