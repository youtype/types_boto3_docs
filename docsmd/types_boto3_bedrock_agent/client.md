...
Type annotations and code completion for `#!python boto3.client("bedrock-agent").close` method.
...
def create_agent(
    ...
    *,
    ...
    clientToken: str = ...,
    customOrchestration: CustomOrchestrationTypeDef = ...,  # (1)
    ...
    instruction: str = ...,
    memoryConfiguration: MemoryConfigurationTypeDef = ...,  # (3)
    orchestrationType: OrchestrationTypeType = ...,  # (4)
    promptOverrideConfiguration: PromptOverrideConfigurationTypeDef = ...,  # (5)
    tags: Mapping[str, str] = ...,
) -> CreateAgentResponseTypeDef:  # (6)
    ...
```
...
6. See [:material-code-braces: CreateAgentResponseTypeDef](./type_defs.md#createagentresponsetypedef) 
...
4. See [:material-code-brackets: OrchestrationTypeType](./literals.md#orchestrationtypetype) 
5. See [:material-code-braces: PromptOverrideConfigurationTypeDef](./type_defs.md#promptoverrideconfigurationtypedef) 
6. See [:material-code-braces: UpdateAgentResponseTypeDef](./type_defs.md#updateagentresponsetypedef) 
