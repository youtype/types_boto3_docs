...
class AgenticRetrieveActionTypeDef(TypedDict):
    ...
    retrieve: NotRequired[AgenticRetrieveActionDetailsTypeDef],  # (2)
```
...
2. See [:material-code-braces: AgenticRetrieveActionDetailsTypeDef](./type_defs.md#agenticretrieveactiondetailstypedef)
...
class AgenticRetrieveStreamRequestTypeDef(TypedDict):
    ...
    nextToken: NotRequired[str],
    policyConfiguration: NotRequired[AgenticRetrievePolicyConfigurationTypeDef],  # (4)
    userContext: NotRequired[UserContextTypeDef],  # (5)
```
...
4. See [:material-code-braces: AgenticRetrievePolicyConfigurationTypeDef](./type_defs.md#agenticretrievepolicyconfigurationtypedef)
