...
result = client.generate_query()  # (2)
```
...
from types_boto3_bedrock_agent_runtime.type_defs import GenerateQueryRequestRequestTypeDef
...
result: GenerateQueryResponseTypeDef = client.generate_query(**kwargs)
```
