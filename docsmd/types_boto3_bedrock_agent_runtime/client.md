...
def agentic_retrieve_stream(
    ...
    *,
    ...
    nextToken: str = ...,
    policyConfiguration: AgenticRetrievePolicyConfigurationTypeDef = ...,  # (4)
    userContext: UserContextTypeDef = ...,  # (5)
) -> AgenticRetrieveStreamResponseTypeDef:  # (6)
    ...
```
...
6. See [:material-code-braces: AgenticRetrieveStreamResponseTypeDef](./type_defs.md#agenticretrievestreamresponsetypedef)
