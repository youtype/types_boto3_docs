...
) -> PageIterator[ListJobsOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    vaultName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListMultipartUploadsOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    uploadId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListPartsOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    accountId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListVaultsOutputTypeDef]:  # (2)
    ...
```
