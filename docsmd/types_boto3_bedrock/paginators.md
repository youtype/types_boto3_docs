...
) -> botocore.paginate.PageIterator[ListCustomModelsResponseTypeDef]:  # (4)
    ...
```
...
4. See `PageIterator[ListCustomModelsResponseTypeDef]`
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> botocore.paginate.PageIterator[ListPromptRoutersResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `PageIterator[ListPromptRoutersResponseTypeDef]`
