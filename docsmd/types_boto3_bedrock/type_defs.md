...
class AccountEnforcedGuardrailOutputConfigurationTypeDef(TypedDict):
    ...
    modelEnforcement: NotRequired[ModelEnforcementOutputTypeDef],  # (3)
```
...
3. See [:material-code-braces: ModelEnforcementOutputTypeDef](./type_defs.md#modelenforcementoutputtypedef)
