...
3. item: `PageIterator[DescribeStorageSystemResourceMetricsResponseTypeDef]`
...
) -> botocore.paginate.PageIterator[DescribeStorageSystemResourceMetricsResponseTypeDef]:  # (3)
    ...
```

1. See [:material-code-brackets: DiscoveryResourceTypeType](./literals.md#discoveryresourcetypetype)
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
3. See `PageIterator[DescribeStorageSystemResourceMetricsResponseTypeDef]`
...
3. item: `PageIterator[ListDiscoveryJobsResponseTypeDef]`
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> botocore.paginate.PageIterator[ListDiscoveryJobsResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `PageIterator[ListDiscoveryJobsResponseTypeDef]`
...
3. item: `PageIterator[ListStorageSystemsResponseTypeDef]`
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> botocore.paginate.PageIterator[ListStorageSystemsResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `PageIterator[ListStorageSystemsResponseTypeDef]`
