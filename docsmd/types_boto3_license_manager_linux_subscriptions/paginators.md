...
) -> PageIterator[ListLinuxSubscriptionInstancesResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListLinuxSubscriptionsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListRegisteredSubscriptionProvidersResponseTypeDef]:  # (3)
    ...
```
