...
) -> PageIterator[DescribeBatchPredictionsOutputTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    SortOrder: SortOrderType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> PageIterator[DescribeDataSourcesOutputTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    SortOrder: SortOrderType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> PageIterator[DescribeEvaluationsOutputTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    SortOrder: SortOrderType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> PageIterator[DescribeMLModelsOutputTypeDef]:  # (4)
    ...
```
