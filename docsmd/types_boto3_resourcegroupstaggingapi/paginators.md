...
) -> PageIterator[GetComplianceSummaryOutputTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[GetResourcesOutputTypeDef]:  # (3)
    ...
```
...
) -> PageIterator[GetTagKeysOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    Key: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[GetTagValuesOutputTypeDef]:  # (2)
    ...
```
