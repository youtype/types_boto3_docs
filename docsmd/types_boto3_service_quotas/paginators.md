...
) -> PageIterator[ListAWSDefaultServiceQuotasResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListRequestedServiceQuotaChangeHistoryByQuotaResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    QuotaRequestedAtLevel: AppliedLevelEnumType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> PageIterator[ListRequestedServiceQuotaChangeHistoryResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    AwsRegion: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListServiceQuotaIncreaseRequestsInTemplateResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListServiceQuotasResponseTypeDef]:  # (3)
    ...
```
