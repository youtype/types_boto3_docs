...
) -> PageIterator[AdminListGroupsForUserResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Username: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[AdminListUserAuthEventsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    UserPoolId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListIdentityProvidersResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    UserPoolId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListResourceServersResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    UserPoolId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListUserPoolClientsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListUserPoolsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    GroupName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListUsersInGroupResponseTypeDef]:  # (2)
    ...
```
