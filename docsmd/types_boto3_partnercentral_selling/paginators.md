...
) -> _PageIterator[ListEngagementByAcceptingInvitationTasksResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    TaskStatus: Sequence[TaskStatusType] = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> _PageIterator[ListEngagementFromOpportunityTasksResponseTypeDef]:  # (4)
    ...
```
...
) -> _PageIterator[ListEngagementInvitationsResponseTypeDef]:  # (6)
    ...
```
...
) -> _PageIterator[ListEngagementMembersResponseTypeDef]:  # (2)
    ...
```
...
) -> _PageIterator[ListEngagementResourceAssociationsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[ListEngagementsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> _PageIterator[ListResourceSnapshotJobsResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    ResourceType: ResourceTypeType = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[ListResourceSnapshotsResponseTypeDef]:  # (3)
    ...
```
