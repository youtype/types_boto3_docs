...
class ContentBlockOutputTypeDef(TypedDict):
    ...
    searchResult: NotRequired[SearchResultBlockOutputTypeDef],  # (10)
```
...
10. See [:material-code-braces: SearchResultBlockOutputTypeDef](./type_defs.md#searchresultblockoutputtypedef)
...
class ContentBlockTypeDef(TypedDict):
    ...
    searchResult: NotRequired[SearchResultBlockUnionTypeDef],  # (10)
```
...
10. See [:material-code-braces: SearchResultBlockUnionTypeDef](#searchresultblockuniontypedef)
