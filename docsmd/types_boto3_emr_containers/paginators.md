...
) -> PageIterator[ListJobRunsResponsePaginatorTypeDef]:  # (3)
    ...
```
...
) -> PageIterator[ListJobTemplatesResponsePaginatorTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListManagedEndpointsResponsePaginatorTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    createdBefore: TimestampTypeDef = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListSecurityConfigurationsResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListVirtualClustersResponseTypeDef]:  # (4)
    ...
```
