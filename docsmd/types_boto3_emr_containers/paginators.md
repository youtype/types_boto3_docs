...
) -> _PageIterator[ListJobRunsResponsePaginatorTypeDef]:  # (3)
    ...
```
...
) -> _PageIterator[ListJobTemplatesResponsePaginatorTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[ListManagedEndpointsResponsePaginatorTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    createdBefore: TimestampTypeDef = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListSecurityConfigurationsResponseTypeDef]:  # (2)
    ...
```
