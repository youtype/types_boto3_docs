...
class VulnerabilityTypeDef(TypedDict):
    ...
    cvss2: NotRequired[Cvss2TypeDef],  # (5)
    ...
    epss: NotRequired[EpssTypeDef],  # (7)
```
...
5. See [:material-code-braces: Cvss2TypeDef](./type_defs.md#cvss2typedef)
6. See [:material-code-braces: ExploitObservedTypeDef](./type_defs.md#exploitobservedtypedef)
7. See [:material-code-braces: EpssTypeDef](./type_defs.md#epsstypedef)
