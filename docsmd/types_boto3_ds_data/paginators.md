...
) -> PageIterator[ListGroupMembersResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Realm: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListGroupsForMemberResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Realm: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListGroupsResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Realm: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListUsersResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Realm: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[SearchGroupsResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Realm: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[SearchUsersResultTypeDef]:  # (2)
    ...
```
