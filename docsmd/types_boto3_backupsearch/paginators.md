...
) -> PageIterator[ListSearchJobBackupsOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    SearchJobIdentifier: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListSearchJobResultsOutputTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListSearchJobsOutputTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    SearchJobIdentifier: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListSearchResultExportJobsOutputTypeDef]:  # (3)
    ...
```
