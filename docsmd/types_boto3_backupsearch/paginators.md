...
) -> _PageIterator[ListSearchJobBackupsOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    SearchJobIdentifier: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> _PageIterator[ListSearchJobResultsOutputTypeDef]:  # (2)
    ...
```
...
) -> _PageIterator[ListSearchJobsOutputTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    SearchJobIdentifier: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> _PageIterator[ListSearchResultExportJobsOutputTypeDef]:  # (3)
    ...
```
