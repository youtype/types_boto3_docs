...
def create_cluster(
    ...
    *,
    ...
    ClusterRole: str = ...,
    AutoScaling: ClusterAutoScalingConfigTypeDef = ...,  # (8)
...
8. See [:material-code-braces: ClusterAutoScalingConfigTypeDef](./type_defs.md#clusterautoscalingconfigtypedef)
...
def update_cluster(
    ...
    *,
    ...
    ClusterRole: str = ...,
    AutoScaling: ClusterAutoScalingConfigTypeDef = ...,  # (4)
) -> UpdateClusterResponseTypeDef:  # (5)
    ...
```
...
4. See [:material-code-braces: ClusterAutoScalingConfigTypeDef](./type_defs.md#clusterautoscalingconfigtypedef)
5. See [:material-code-braces: UpdateClusterResponseTypeDef](./type_defs.md#updateclusterresponsetypedef)
