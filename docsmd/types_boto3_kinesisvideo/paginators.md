...
) -> PageIterator[DescribeMappedResourceConfigurationOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    HubDeviceArn: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListEdgeAgentConfigurationsOutputTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListSignalingChannelsOutputTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListStreamsOutputTypeDef]:  # (3)
    ...
```
