...
) -> PageIterator[ListExportTasksOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    graphIdentifier: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListGraphSnapshotsOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListGraphsOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListImportTasksOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    graphIdentifier: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> PageIterator[ListPrivateGraphEndpointsOutputTypeDef]:  # (2)
    ...
```
