...
def start_pipeline_execution(
    ...
    *,
    ...
    clientToken: str = ...,
) -> StartPipelineExecutionResponseTypeDef:  # (2)
    ...
```

1. See [:material-code-braces: ExecutionEnvironmentVariablesUnionTypeDef](#executionenvironmentvariablesuniontypedef)
2. See [:material-code-braces: StartPipelineExecutionResponseTypeDef](./type_defs.md#startpipelineexecutionresponsetypedef)
