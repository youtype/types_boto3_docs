...
Can be used with `types-boto3[agent-registry]` package installed.
...
With `types-boto3-lite[agent-registry]`
or a standalone `types_boto3_agent_registry` package, you have to explicitly specify `client: AgentRegistryClient` type annotation.
...
from types_boto3_agent_registry.client import AgentRegistryClient
from types_boto3_agent_registry.paginator import ListDiscoverableRegistryRecordsPaginator
