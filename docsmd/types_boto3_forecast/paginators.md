...
) -> PageIterator[ListDatasetGroupsResponseTypeDef]:  # (2)
    ...
```
...
) -> PageIterator[ListDatasetImportJobsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListExplainabilitiesResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListExplainabilityExportsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListForecastExportJobsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListForecastsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListMonitorEvaluationsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListMonitorsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListPredictorBacktestExportJobsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListPredictorsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListWhatIfAnalysesResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListWhatIfForecastExportsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> PageIterator[ListWhatIfForecastsResponseTypeDef]:  # (3)
    ...
```
