...
) -> PageIterator[ListJobTemplatesResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Order: OrderType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> PageIterator[ListPresetsResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Order: OrderType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> PageIterator[ListQueuesResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    Status: JobStatusType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> PageIterator[SearchJobsResponseTypeDef]:  # (4)
    ...
```
